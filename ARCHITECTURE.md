...
- 2026-07-29 — [Task 7 picker spike] candidate (a) confirmed: `react-day-picker` 10.0.1 with `@daypicker/persian` 10.0.1 supplies Jalali leap-year math, Persian digits, and RTL calendar semantics. Astryx `Popover`, `Button`, and `Text` custom components provide token-driven light/dark styling; the wrapper explicitly preserves RTL arrow focus and PageUp/PageDown month navigation.
